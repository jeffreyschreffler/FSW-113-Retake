...
const fetchData = async(city) => {
    const response = await fetch (`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=cb88ccd906064cfe6a757fee8c8dce55`);
    try {
...
//key cb88ccd906064cfe6a757fee8c8dce55
